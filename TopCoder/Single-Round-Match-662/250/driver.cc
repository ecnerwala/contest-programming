...
#include "FoxesOfTheRoundTable.cc"
...
int main(int argc, char* argv[])
{
	...
	for(;;)
	{
		...
		std::cout << "# input for test " << __testnum << ": " << h << std::endl;
		std::cout.flush();

		__timer_start();

		FoxesOfTheRoundTable __object;
		vector <int> __actual = __object.minimalDifference(h);
